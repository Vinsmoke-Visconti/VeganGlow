        ...
        >
          ...
          >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 h-10 px-5 rounded-full border border-border bg-white/50 backdrop-filter blur-sm text-sm text-text-secondary hover:border-error hover:text-error transition"
            >
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div
                        style={{
                          ...
                          marginTop: 16,
                          paddingTop: 16,
                          borderTop: '1px solid rgba(240, 237, 232, 0.5)',
                        }}
                      >
                        {/* Quantity picker */}
                        <div
                          style={{
                            ...
                            borderRadius: 9999,
                            border: '1px solid rgba(232, 229, 224, 0.5)',
                            backgroundColor: 'rgba(250, 249, 247, 0.5)',
                          }}
                        >
                          <button
                            type="button"
