...
export function AuditFilters({ defaultValue }: { defaultValue?: string }) {
  ...
  return (
    <div className={shared.filterBar}>
      ...
      <Link href="/admin/audit-logs" className={`${shared.btn} ${shared.btnGhost}`} style={{ height: 32, padding: '0 8px' }}>
        <RotateCcw size={12} />
      </Link>
    </div>
  );
